---
name: PAI Security System (User Customizations)
description: Your personal security patterns and policies.
details: Start with patterns.yaml to add your custom sensitive data patterns.
---
