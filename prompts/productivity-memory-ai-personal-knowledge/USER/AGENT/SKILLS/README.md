---
name: Skill Customizations
description: User-specific preferences and extensions for system skills.
details: System skills check SKILLS/{SkillName}/ for user customizations before executing.
---
# SKILLCUSTOMIZATIONS
...
```bash
mkdir -p ~/.claude/skills/CORE/USER/SKILLCUSTOMIZATIONS/SkillName
```
...
```bash
mkdir -p ~/.claude/skills/CORE/USER/SKILLCUSTOMIZATIONS/Art
```
...
See: `~/.claude/skills/CORE/SYSTEM/SKILLSYSTEM.md` (Skill Customization System section)
