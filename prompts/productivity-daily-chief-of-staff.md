...
- **Hooks over prompts for reliability**: LLMs nexust instructions ~20% of the time. `PostToolUse` hooks enforce checklists at the tool level — the LLM physically cannot skip them.
