...
const { SKILLS_DIR, OUTPUT_DIR, getAvailableSkills } = require('../core/skills');
...
function buildMarkdown(pairs, clusters, skillCount, threshold, now) {
  ...
  L.push('');
  L.push('---');
  L.push('*Generated by `node src/audit/skill-overlap-report.js`. Rerun after any catalog change.*');
  return L.join('\n');
}
